                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="month" name="monthly_number_of_requests" value="0" autocomplete="monthly requests">
                        </div>
                        <div class="form-group">
                            <!-- <label for="text">Daily Requests</label> -->
                            <input type="hidden" class="form-control" id="month" name="daily_number_of_requests" value="0" autocomplete="Daily requests">
                        </div>
                        <div class="form-group">
                            <!-- <label for="text">Average Monthly Requests</label> -->
                            <input type="hidden" class="form-control" id="month" name="avg_monthly_number_of_requests" value="0" autocomplete="Average Monthly Requests">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="month" name="subscriptionID" value="unsubscribed" autocomplete="Subscription ID">
                        </div>
                        <div class="form-group">
                            <label for="text">Expire Date</label>
                            <input type="text" class="form-control" id="month" name="expire_date" value="{{$date}}" autocomplete="Expire Date">
                        </div>
                        <div class="form-group">
                            <!-- <label for="text">Subscribe Status</label> -->
                            <input type="hidden" class="form-control" id="status" name="subscribe_status" value="completed" autocomplete="Subscribe Status">
                        </div>

                        <div class="form-group">
                            <input type="hidden" class="form-control" id="logged_status" name="current_logged_status" value="false" autocomplete="Current logged status">
                        </div>
